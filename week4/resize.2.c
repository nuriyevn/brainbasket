...
int main(int argc, char* argv[])
{
    ...
    // determine outfile's BITMAPINFOHEADER && BITMAPFILEHEADER
       
    int* new_biWidth;
    new_biWidth= &bi.biWidth;
    *new_biWidth = bi.biWidth * n; 
    int* new_biHeight;
    new_biHeight = &bi.biHeight ;
    *new_biHeight = bi.biHeight * n; 
